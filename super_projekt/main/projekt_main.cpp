...
#include "../classes/table.cc"
#include "../classes/ship.cc"

using namespace std;
void magicSpace()//just making 1000 empty lines so no one  can see moves of players\g
{
for (int i = 0; i < 100; i++)
    {
        cout<<"="<<endl;
...
int main()
{
   bool winstatus1=false,winstatus2=false;
    char playingfield1[10][10],playingfield2[10][10],
...
table mytable1( playingfield1);
table aimingboard1(playingfield2);
...
player myplayer2(0);
table mytable2( playingfield3);
table aimingboard2(playingfield4);
